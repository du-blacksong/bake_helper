...
<template>
  <div class="bottom">
    ...
    <div class="bottomicon">
      <div @click="goTouniversity(10163)" class="iconitem">
        <img alt="" title=""
      ...
      <div @click="goTouniversity(10162)" class="iconitem">
        <img alt="" title=""
      ...
      <div @click="goTouniversity(10164)" class="iconitem">
        <img alt="" title=""
      ...
      <div @click="goTouniversity(10166)" class="iconitem">
        <img alt="" title=""
...
name: "hpbDesc",
  methods:{
    goTouniversity(categoryId){
      this.$router.push('/university?categoryId='+categoryId)
    }
  },
